        ...
        gotoPage: function(b, c) {
            ...
            if (a.trim(c) == "" || isNaN(c)) {
                ...
                if (parseInt(c) < 1 || parseInt(c) > b.totalPages) {
                    alert(a.bsgridLanguage.needRange(1, b.totalPages))
                } else {
...
(function($) {
    $.fn.bsgrid = {
        ...
        addRowsClickEvent: function(options) {
            $("#" + options.gridId + " tbody").on("click", "tr", function() {
        ...
        setGridBlankBody: function(options) {
            ...
            if (options.settings.pageSize > 0) {
                ...
                for (var hi = 0; hi < header.length; hi++) {
                    trSb.append('<td style="text1-align: ' + columnsModel[hi].align + ";");
...
(function(a) {
    ...
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.initGridMethods, "initGridOptions", function(b, c) {
        var d = c.columnsModel;
        a.fn.bsgrid.getGridHeaderObject(c).each(function(e) {
            d[e].lineNumber = a.trim(a(this).attr(c.settings.colsProperties.lineNumberAttr));
            d[e].check = a.trim(a(this).attr(c.settings.colsProperties.checkAttr));
            d[e].edit = a.trim(a(this).attr(c.settings.colsProperties.editAttr))
        });
        if (a("#" + c.gridId + " tfoot tr td[" + c.settings.colsProperties.aggAttr + "!='']").length != 0) {
            a("#" + c.gridId + " tfoot tr td").each(function(f) {
                d[f].aggName = "";
                d[f].aggIndex = "";
                var e = a.trim(a(this).attr(c.settings.colsProperties.aggAttr));
                if (e.length != 0) {
                    var g = e.split(",");
                    d[f].aggName = g[0].toLocaleLowerCase();
                    d[f].aggIndex = g.length > 1 ? g[1] : ""
                }
            })
        }
        if (a("#" + c.gridId + " thead tr:last th[" + c.settings.colsProperties.checkAttr + "!='']").length == 0) {
        ...
        if (a.trim(c.settings.extend.settings.searchConditionsContainerId) == "") {
            delete c.settings.extend.initGridMethods.initSearchConditions
        }
        if (a("#" + c.gridId + " tfoot td[" + c.settings.colsProperties.aggAttr + "!='']").length == 0) {
    ...
    a.fn.bsgrid.extendOtherMethods.fixedHeader = function(b, c) {
        ...
        if (d < a("#" + c.gridId).height()) {
            ...
            a("#" + c.gridId).width(a("#" + c.gridId + "_fixedDiv").width() - 18);
            a("#" + c.gridId + "_fixedDiv").animate({
                scrollTop: "0px"
            }, 0)
        } else {
            a("#" + c.gridId + "_fixedDiv").height(a("#" + c.gridId).height());
            a("#" + c.gridId).width(a("#" + c.gridId + "_fixedDiv").width() - 1)
        }
        a("#" + c.gridId + " thead tr:lt(" + e + ")").clone(true).prependTo("#" + c.gridId + " thead");
        a("#" + c.gridId + " thead tr:lt(" + e + ")").css({
            "z-index": 10,
            position: "fixed"
        }).width(a("#" + c.gridId + " thead tr:last").width());
        a("#" + c.gridId + " thead tr:lt(" + e + ")").each(function(h) {
            var g = a("#" + c.gridId + " thead tr:eq(" + (e + h) + ")").position();
            a(this).css({
                top: g.top - f(a(this).find("th").css("border-top-width")),
                left: g.left
            })
        });
        a("#" + c.gridId + " thead tr:gt(" + (e - 1) + ")").each(function(g) {
            a(this).find("th").each(function(j) {
                var h = a(this);
                a("#" + c.gridId + " thead tr:eq(" + g + ") th:eq(" + j + ")").height(h.height() + ((g == e - 1) ? 2 : 1) * f(h.css("border-top-width"))).width(h.width() + f(h.css("border-left-width")))
            })
        });
    ...
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.initGridMethods, "fixedHeader", function(b, c) {
    ...
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.afterRenderGridMethods, "fixedHeader", function(d, c, b) {
    ...
    a.fn.bsgrid.extendInitGrid.bindExtendMethods = function(b, c) {
        ...
        if (c.settings.extend.settings.supportGridEdit) {
            ...
            d.getRowsChangedColumnsValue = function() {
                return a.fn.bsgrid.defaults.extend.getRowsChangedColumnsValue(c)
            }
        }
    };
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.initGridMethods, "bindExtendMethods", a.fn.bsgrid.extendInitGrid.bindExtendMethods);
    a.fn.bsgrid.extendInitGrid.initGridCheck = function(b, c) {
        a.fn.bsgrid.getGridHeaderObject(c).each(function(d) {
            if (c.columnsModel[d].check == "true") {
                if (a.trim(a(this).html()) == "") {
                    a(this).html('<input class="bsgrid_editgrid_check" type="checkbox"/>')
                }
                a(this).find("input[type=checkbox]").change(function() {
                    var e = a.bsgrid.adaptAttrOrProp(a(this), "checked") ? true : false;
                    a.bsgrid.adaptAttrOrProp(a("#" + b + " tbody tr td:nth-child(" + (d + 1) + ")>input[type=checkbox]"), "checked", e)
                })
            }
        })
    };
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.initGridMethods, "initGridCheck", a.fn.bsgrid.extendInitGrid.initGridCheck);
    a.fn.bsgrid.extendInitGrid.initSearchConditions = function(b, c) {
        ...
        a("#" + c.settings.extend.settings.searchConditionsContainerId).html(e.toString());
        a("#" + c.settings.extend.settings.searchConditionsContainerId + " select.bsgrid_conditions_select").change(function() {
            a(this).next("input.bsgrid_conditions_input").attr("name", a(this).val())
        }).trigger("change")
    };
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.initGridMethods, "initSearchConditions", a.fn.bsgrid.extendInitGrid.initSearchConditions);
    a.fn.bsgrid.extendInitGrid.initColumnMove = function(c, d) {
        ...
        e.each(function(g) {
            ...
            a(h).mousemove(function() {
                ...
                var p = h;
                if (g != b - 1 && event.clientX - o > -10) {
                    p = n
                }
                if ((g != 0 && event.clientX - q < 10) || (g != b - 1 && event.clientX - o > -10)) {
                    a(h).css({
                        cursor: "e-resize"
                    });
                    if (a.trim(a(h).data("ex_mousedown")) != "mousedown") {
                        return
                    }
                    var l = a(p).width();
                    var m = l - event.clientX + a(p).offset().left;
                    var k = a(p).prev().width();
                    var i = k + event.clientX - a(p).offset().left;
                    if (parseInt(m) > 19 && parseInt(i) > 19) {
            ...
            a(h).mouseout(function() {
                var i = a(h).offset();
                if (i.top > event.clientY || i.top + a(h).height() < event.clientY) {
                    j(h, g, b)
                }
            });
    ...
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.initGridMethods, "initColumnMove", a.fn.bsgrid.extendInitGrid.initColumnMove);
    a.fn.bsgrid.extendRenderPerColumn.renderCheck = function(b, h, d, e, g, c) {
        if (h < c.curPageRowsNum) {
            var f = c.columnsModel[d];
            if (f.check == "true") {
                return '<input class="bsgrid_editgrid_check" type="checkbox" value="' + a.fn.bsgrid.getRecordIndexValue(b, f.index, c) + '"/>'
            }
        }
        return false
    };
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.renderPerColumnMethods, "renderCheck", a.fn.bsgrid.extendRenderPerColumn.renderCheck);
    a.fn.bsgrid.extendRenderPerColumn.renderForm = function(c, f, i, b, e, j) {
        if (f < j.curPageRowsNum) {
            ...
            if (h == "checkbox") {
                return g + '<input class="bsgrid_editgrid_hidden bsgrid_editgrid_checkbox" type="' + h + '" value="' + g + '"/>'
            } else {
                if (h == "text" || h == "hidden" || h == "password" || h == "radio" || h == "button") {
                    return g + '<input class="bsgrid_editgrid_hidden bsgrid_editgrid_edit" type="' + h + '" value="' + g + '"/>'
                } else {
                    if (h == "textarea") {
                        return g + '<textarea class="bsgrid_editgrid_hidden bsgrid_editgrid_edit">' + g + "</textarea>"
                    }
                }
            }
        }
    ...
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.renderPerColumnMethods, "renderForm", a.fn.bsgrid.extendRenderPerColumn.renderForm);
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.afterRenderGridMethods, "renderLineNumber", function(d, c, b) {
        a.fn.bsgrid.getGridHeaderObject(b).each(function(f) {
            var e = b.columnsModel[f].lineNumber;
            if (e == "line" || e == "total_line") {
                a("#" + b.gridId + " tbody tr:lt(" + b.curPageRowsNum + ") td:nth-child(" + (f + 1) + ")").each(function(g) {
                    a(this).html((e == "line") ? (g + 1) : (g + b.startRow))
                })
            }
        })
    });
    a.fn.bsgrid.extendAfterRenderGrid.addCheckChangedEvent = function(d, c, b) {
        a.fn.bsgrid.getGridHeaderObject(b).each(function(e) {
            if (b.columnsModel[e].checkAttr == "true") {
                var g = a(this).find("input[type=checkbox]");
                var f = a("#" + b.gridId + " tbody tr td:nth-child(" + (e + 1) + ")>input[type=checkbox]");
                f.change(function() {
                    var h = a.bsgrid.adaptAttrOrProp(g, "checked") ? true : false;
                    if (!h && f.filter(":checked").length == f.length) {
                        a.bsgrid.adaptAttrOrProp(g, "checked", true)
                    } else {
                        if (h && f.filter(":checked").length != f.length) {
                            a.bsgrid.adaptAttrOrProp(g, "checked", false)
                        }
                    }
                })
            }
    ...
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.afterRenderGridMethods, "addCheckChangedEvent", a.fn.bsgrid.extendAfterRenderGrid.addCheckChangedEvent);
    a.fn.bsgrid.extendAfterRenderGrid.addGridEditEvent = function(e, c, b) {
        a("#" + b.gridId + " tbody tr:lt(" + b.curPageRowsNum + ")").each(function(f) {
            var g = this;
            var h = b.columnsModel;
            a(g).find("td").each(function(i) {
                if (h[i].edit != "") {
                    a(this).find(".bsgrid_editgrid_checkbox, .bsgrid_editgrid_edit").change(function() {
                        if (a.trim(a(this).val()) != a.fn.bsgrid.getGridObj(b.gridId).getColumnValue(f, h[i].index)) {
                            a(this).addClass("bsgrid_editgrid_change")
                        } else {
                            a(this).removeClass("bsgrid_editgrid_change")
                        }
                        a(g).data("change", a(g).find(".bsgrid_editgrid_change").length)
                    })
                }
            });
            if (b.settings.extend.settings.supportGridEditTriggerEvent == "") {
                a(this).find(".bsgrid_editgrid_hidden").each(function() {
                    d(this)
                })
            } else {
                    ...
                    if (b.settings.extend.settings.supportGridEditTriggerEvent == "rowDoubleClick") {
                        ...
                        if (b.settings.extend.settings.supportGridEditTriggerEvent == "cellClick") {
                            ...
                            if (b.settings.extend.settings.supportGridEditTriggerEvent == "cellDoubleClick") {
                                a(this).find(".bsgrid_editgrid_hidden").each(function() {
                                    var i = this;
                                    a(i).parent("td").dblclick(function() {
                                        d(i)
                                    })
                                })
                            }
    ...
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.afterRenderGridMethods, "addGridEditEvent", a.fn.bsgrid.extendAfterRenderGrid.addGridEditEvent);
    a.fn.bsgrid.extendAfterRenderGrid.aggregation = function(f, c, b) {
        var e = a.fn.bsgrid.getGridObj(b.gridId);
        var d = b.columnsModel;
        a("#" + b.gridId + " tfoot tr td[" + b.settings.colsProperties.aggAttr + "!='']").each(function(g) {
            if (d[g].aggName != "") {
                var k = d[g].aggName;
                var j = null;
                if (k == "count") {
                    ...
                    if (k == "countnotnone" || k == "sum" || k == "avg" || k == "max" || k == "min" || k == "concat") {
                        if (k == "countnotnone") {
                            j = 0
                        }
                        var h = new StringBuilder();
                        a("#" + b.gridId + " tbody tr:lt(" + b.curPageRowsNum + ")").each(function(i) {
                            var l = e.getColumnValue(i, d[g].aggIndex);
                            if (l == "") {} else {
                                if (k == "countnotnone") {
                                    j = (j == null ? 0 : j) + 1
                                } else {
                                    if (k == "sum" || k == "avg") {
                                        if (!isNaN(l)) {
                                            j = (j == null ? 0 : j) + parseFloat(l)
                                        }
                                    } else {
                                        if (k == "max" || k == "min") {
                                            if (!isNaN(l) && (j == null || (k == "max" && parseFloat(l) > j) || (k == "min" && parseFloat(l) < j))) {
                                                j = parseFloat(l)
                                            }
                                        } else {
                                            if (k == "concat") {
    ...
    a.bsgrid.forcePushPropertyInObject(a.fn.bsgrid.defaults.extend.afterRenderGridMethods, "aggregation", a.fn.bsgrid.extendAfterRenderGrid.aggregation);
    ...
    a.fn.bsgrid.defaults.extend.getCheckedRowsRecords = function(c) {
        var b = [];
        a.each(a.fn.bsgrid.defaults.extend.getCheckedRowsIndexs(c), function(d, e) {
    ...
    a.fn.bsgrid.defaults.extend.activeGridEditMode = function(b) {
        ...
        a("#" + b.gridId + " tbody tr:lt(" + b.curPageRowsNum + ") td .bsgrid_editgrid_hidden").each(function() {
    ...
    a.fn.bsgrid.defaults.extend.getChangedRowsOldRecords = function(c) {
        var b = [];
        a.each(a.fn.bsgrid.defaults.extend.getChangedRowsIndexs(c), function(d, e) {
            b[b.length] = a.fn.bsgrid.getRecord(e, c)
        });
        return b
    };
    a.fn.bsgrid.defaults.extend.getRowsChangedColumnsValue = function(c) {
        ...
        a.each(a.fn.bsgrid.defaults.extend.getChangedRowsIndexs(c), function(d, e) {
            b["row_" + e] = {};
            a("#" + c.gridId + " tbody tr:eq(" + e + ") td").each(function(f) {
                if (a(this).find(".bsgrid_editgrid_change").length > 0) {
                    b["row_" + e][c.columnsModel[f].index] = a(this).find(".bsgrid_editgrid_change").val()
                }
            })
        });
        return b
        ...
        doExport: function(g, l, c) {
            ...
            for (var e = 0; e < g.length; e++) {
                if (a.trim(g.eq(e).attr(b.colsProperties.exportAttr)) != "false") {
                    ...
                    f = f + "," + a.trim(g.eq(e).attr(b.colsProperties.indexAttr));
                    var k = a.trim(g.eq(e).attr(b.colsProperties.widthAttr)).toLocaleLowerCase();
                    ...
                    if (isNaN(k)) {
                        if (k.endWith("px")) {
                            ...
                            if (k.endWith("%")) {
                                k = k.replace("%", "");
                                if (!isNaN(k)) {
                                    d = b.colWidthPercentmultiplier * parseInt(k)
                                }
                            }
                        }
                    }
